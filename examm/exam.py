...
name_fam = [b for b in bigrams if re.search('^[А-Я]\. [А-Я][^\s\d\.\,]+', b)]
print(name_fam)

#задание 2

name_fam1 = [b for b in bigrams if re.search('^[А-Я][а-я]+ [А-Я][а-я]', b)]
...
name_fam2 = [b for b in bigramss if re.search('^[А-Я]\. [А-Я]\. [А-Я][^\s\d\.\,]+', b)]
print(name_fam1)
print(name_fam2)
